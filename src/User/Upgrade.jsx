                    ...
                    <form className="bg-white rounded-lg p-8 w-4/12 mobile:w-10/12">
                        ...
                        <div className="flex items-center gap-4 py-2">
                            ...
                            <div className="flex items-center p-2 rounded-lg bg-gray-100">
                                <div className={`text-xs px-6 py-2 cursor-pointer rounded-lg ${period === "monthly" ? "bg-white text-primary shadow font-bold" : ""}`} onClick={() => setPeriod('monthly')}>
                                    Triwulan
                                </div>
                                <div className={`text-xs px-6 py-2 cursor-pointer rounded-lg ${period === "yearly" ? "bg-white text-primary shadow font-bold" : ""}`} onClick={() => setPeriod('yearly')}>
                                    Tahunan
                                </div>
                            </div>
                        </div>
