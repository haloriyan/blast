            ...
            <Sidebar active="dashboard" />
            {
                ...
                <div className={`absolute top-20 right-0 ${isExpanded ? 'w-9/12' : 'w-11/12'} mobile:w-full p-4 ps-0 mobile:ps-4`}>
                    <div className="flex items-center justify-end gap-4 mt-6">
                        ...
                        <button className="p-2 px-4 rounded-lg bg-green-100 text-green-500 flex gap-2">
                            <IconPlus />
                            Buat Broadcast
                        </button>
                    </div>
                    ...
                    <div className="flex gap-8">
                        <div className="bg-white rounded-lg p-8 shadow shadow-[0px_16px_32px_rgba(0,0,0,0.05)] flex flex-col grow">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="text-slate-500 text-sm">Dari 200</div>
                            </div>
                        ...
                        <div className="bg-white rounded-lg p-8 shadow shadow-[0px_16px_32px_rgba(0,0,0,0.05)] flex flex-col grow">
                            <div className="text-slate-500">Limit Broadcast Harian</div>
                            <div className="flex items-center gap-4">
                                <div className="text-slate-700 font-bold text-4xl flex grow">300</div>
                                <div className="text-slate-500 text-sm">Dari 200</div>
                            </div>
                    ...
                    <div className="flex gap-8 mt-8">
                        <div className="bg-white rounded-lg p-8 shadow shadow-[0px_16px_32px_rgba(0,0,0,0.05)] flex flex-col grow">
                            ...
                            <div className="flex gap-4 mt-4">
                                ...
                                <Link to={'/devices'} className="bg-gray-500 text-white aspect-video rounded-lg p-4 flex flex-col grow">
                                    <div>Tidak Aktif</div>
                                    <div className="text-4xl font-bold">8</div>
                                </Link>
                            </div>
                        </div>
                        <div className="bg-white rounded-lg p-8 shadow shadow-[0px_16px_32px_rgba(0,0,0,0.05)] flex flex-row gap-8 grow">
                            <div className="w-5/12 aspect-square bg-slate-200 rounded-lg relative">
