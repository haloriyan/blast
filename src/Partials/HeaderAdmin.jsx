        ...
        <>
...

            {
                ...
                <div className="fixed z-20 top-24 shadow-[0px_16px_32px_rgba(0,0,0,0.05)] right-5 bg-white rounded-lg flex flex-col">
                    ...
                    <Link to={'/devices'} className="p-3 px-6 flex items-center gap-4 text-slate-500 text-sm hover:bg-gray-100">
                        <IconDeviceMobile size={16} />
                        Perangkat
                    </Link>
                    <Link to={'/account'} className="p-3 px-6 flex items-center gap-4 text-slate-500 text-sm hover:bg-gray-100">
                        <IconHelp size={16} />
                        Need Help?
                    </Link>
                    <Link to={'/logout'} className="p-3 px-6 flex items-center gap-4 text-red-500 text-sm hover:bg-gray-100 rounded-bl-lg rounded-br-lg border-t">
                        Sign Out
                    </Link>
                </div>
            }
